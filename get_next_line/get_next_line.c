...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/29 18:52:29 by mstoneho          #+#    #+#             */
/*   Updated: 2020/12/29 18:52:31 by mstoneho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**   ---------------------------------------------------------------------------
**
**   Write a function will store, in the parameter "line", a line that has been
...
**
**   What we call a "line that has been read" is a succession of 0 to n
**   characters that end with '\n' (ascii code 0x0a) or with End Of File (EOF).
**
**   The string stored in the parameter "line" should not contained any '\n'.
**
**   The parameter is the address of a pointer to a character that will be used
**   to store the line read.
**
**   The return value can be 1, 0 or -1 depending on whether a line has been
**   read, when the reading has been completed (meaning read has returned 0),
...
**
**   Calling your function get_next_line in a loop will therefore allow you
**   to read the text available on a file descriptor one line at a time until
**   the end of the text, no matter the size of either the text or one
**   of its lines.
**
...
**   2 calls of get_next_line.
**
**   Finally we consider that get_next_line has an undefined behavior when
